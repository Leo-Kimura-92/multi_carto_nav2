...
def generate_launch_description():
    ...
    nav2_params_file = os.path.join(multi_carto_nav2_dir, 'params', 'single.yaml') 
    ...
    robot_group = GroupAction([
        ...
        Node(
            ...
            arguments=[
                ...
                '-configuration_basename', 'single.lua'
            ],
            remappings=[
                ('scan', '/scan'),
                ('imu', '/imu'),
        ...
        Node(
            ...
            executable='rviz2',
            name='rviz2',
            arguments=['-d', os.path.join(multi_carto_nav2_dir, 'rviz', 'single.rviz')],
            output='screen'
        ),
    ])
